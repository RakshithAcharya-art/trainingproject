...
//load data into widgets
                Text("${querySnapshot.documents[1].data['email']}",style: TextStyle(color: Colors.white),),
                Text("${querySnapshot.documents[1].data['password']}",style: TextStyle(color: Colors.white),),
